...
def main() -> None:
    ...
    print(f"")
    print(f"Best max Sp PnL:")
    print(f"Research = {best_max_speed_pnl.research_percentage}%")
    print(f"Scale = {best_max_speed_pnl.scale_percentage}%")
    ...
    print(f"Research = {best_min_speed_pnl.research_percentage}%")
    print(f"Scale = {best_min_speed_pnl.scale_percentage}%")
