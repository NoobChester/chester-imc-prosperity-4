...
def main() -> None:
    ...
    print(f"")
    print(f"Best max speed PnL:")
    print(f"research percentage = {best_max_speed_pnl.research_percentage}%")
    print(f"scale percentage = {best_max_speed_pnl.scale_percentage}%")
    print(f"PnL at max speed = {best_max_speed_pnl.max_speed_pnl}")
    print(f"PnL at min speed = {best_max_speed_pnl.min_speed_pnl}")
    print(f"")
    print(f"Best min speed PnL:")
    print(f"research percentage = {best_min_speed_pnl.research_percentage}%")
    print(f"scale percentage = {best_min_speed_pnl.scale_percentage}%")
    print(f"PnL at max speed = {best_min_speed_pnl.max_speed_pnl}")
    print(f"PnL at min speed = {best_min_speed_pnl.min_speed_pnl}")
    print(f"")
